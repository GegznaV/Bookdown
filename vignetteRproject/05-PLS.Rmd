...
library(rgl)
knit_hooks$set(webgl = hook_webgl) ## to include 3d images in the html vignette - 3D chunks must have webgl=TRUE
```
...
```{r 05-pls-cim-1, webgl=TRUE}
X11()
cim(MyResult.spls, comp = 1)
```
```{r 05-pls-cim-2, eval= FALSE}
## or save it
