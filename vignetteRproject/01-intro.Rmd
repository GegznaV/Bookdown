...
```{r 01-global_options, include=FALSE}
library(knitr)
# global options
...
```{r 01-overview, echo=FALSE, message=FALSE}
library(mixOmics)
coul <- color.mixo(1:3)
...
```{r 01-methods, echo=FALSE, fig.cap="List of methods in mixOmics, sparse indicates methods that perform variable selection", out.width='100%', fig.align='center'}
...
Each of the method's chapter has the following outline:
