...
\hypersetup{unicode=true,
            ...
            pdfauthor={Kim-Anh Le Cao, Sebastien Dejean, Al J Abadi},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{center}\includegraphics[width=0.75\linewidth,]{Figures/03-pca-liver-1-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,]{Figures/03-pca-liver-loadings-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,]{Figures/03-pca-liver-loadings-args-1} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth,]{Figures/03-pca-liver-plotIndiv-args-1} \end{center}
...
\KeywordTok{summary}\NormalTok{(Y) }\CommentTok{## class summary}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.75\linewidth,]{Figures/04-tune-values-1} \end{center}
